...
export default function MobileOverlay({project, displayNone}) {
    ...
    return (
      <div className="absolute full-container overlay-all transdarkgray">
          <div className="label-flex rounded gray-section">
                ...
                <div className="label-flex">
                  ...
                  <div className="label-flex scroll">
                      ...
                      <a className="rounded purplediv" href={repository}>
                        Repository
                      </a>
                      <a className="rounded purplediv" href={deployment}>
                        Deployment
                      </a>
                  </div>
              </div>
